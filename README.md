...
نرم افزار را بسته به نسخه سیستم عامل خود دانلود واجرا کنید . نوع شکن خود را انتخاب کنید ، اطلاعات مربوطه را وارد کنید و دکمه تنظیم شکن را بفشارید . اگر شکن حرفه ای دارید نرم افزار را برای درست عمل کردم تایمر بروزرسان آی پی باز نگه دارید . پس از اتمام کار اگر به شکن نیاز ندارید می توانید با زدن دکمه تنظیم دی ان اس گوگل یا کلود فلیر دی ان اس های غیر از شکن را بر روی سیستم خود ست کنید .  
 
## ⚠️ توجه 
شکن می تواند سایت هایی که شما بازدید می کنید را مشاهده کند . برای رفع این موضوع هر زمان به شکن نیاز ندارید حتما دکمه تنظیم دی ان اس های گوگل یا کلود فلیر را بفشارید .
